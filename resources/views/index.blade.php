    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme-"dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="ing-fluid" src="assets/images/logo-white.svg" alt="logo" style="width: 40px;">
            </a>
            <!-- Navbar Toggler -->
            ...
            <div class="offcanvas offcanvas-end bg-purple" id="offcanvasNavbar">
                ...
                <div class="offcanvas-body pt-0 px-4">
                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        ...
                        <li class="nav-item col-6 col-md-autp">
                            <a href="#" class="nav-link active">
                                <i class="bi-twitter"></i><small class="ms-2 d-md-none">bi-twitter</small>
                            </a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">
                                <i class="bi-slack"></i><small class="ms-2 s-md-none">Slack</small>
                            </a>
                        </li>
                        <li class="nav-item col-12 col-lg-auto">
                            <div class="vr d-none d-lg-flex h-100 mx-lg-12 text-white"></div>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme-="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <h6 class="dropdown-header">Previus release</h6>
                                    </li>
                        ...
                        <li class="nav-item col-12 col-lg-auto">
                            <div class="vr d-none my-2 text-white-50"></div>
                        </li>
                        <li class="nav-item">
                            <!-- Dropdown -->
                            <div class="dropdown" data-bs-theme-="light">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-md-7 order-md-1">
                    <h1 class="mt-4 display-3">Build first, responsive sites with Boostrap</h1>
                    <p class="fs-5">Quickly design and customize responsive mobile-first sites with Bootrap, the world's most popular front-end open source toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful JavaScript plugins.</p>
                    <div class="row">
                    ...
                    <div class="text-muted">Currently <strong>v5.3.0-alpha2.</strong> . <a href="#">v4.6.x docs</a> . <a href="#">All release</a></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5"><a href="#">Bootsrap Icons</a> is an open source SVG icon library feauturing over 1,800 glyphs, with more added every release. They're designed to work in any project, whether you use Bootsrap itself or not. Use them as SVGs or icon fonts--both options give you vector scaling and easy customization via CSS.</p>
                    <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">Gets Bootsrap Icons <i class="bi bi-arrow-right mb-2"></i></a>
                </div>
                <div class="col-lg-6">
                    <img class="img-fluid" src="assets/images/bs-icons.png" alt="Bootsrap Icons">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">Take Bootstrap to the next level with premium themes from the <a href="#">official Bootstrap Themes marketplace</a>. Themes are built on Bootstrap as their own extended frameworks, rich with  new commponents and plugins, documentation, and powerful build tools.</p>
                    <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">Browse Boostrap Themes <i class="bi bi-arrow-right mb-2"></i></a>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-3 mb-5">
                    ...
                    <div class="mt-2 text-muted">
                        <small>Currently v5.3.0-alppha2.</small>
                    </div>
                </div>
